...
namespace HospitalManagementSystem.Migrations
{
    ...
    [Migration("20240714180022_relations")]
            ...
            modelBuilder.Entity("HospitalManagementSystem.Models.User", b =>
                {
                    b.HasOne("HospitalManagementSystem.Models.Doctor", null)
                        .WithOne("User")
                        .HasForeignKey("HospitalManagementSystem.Models.User", "Username")
                        .HasPrincipalKey("HospitalManagementSystem.Models.Doctor", "Username")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
